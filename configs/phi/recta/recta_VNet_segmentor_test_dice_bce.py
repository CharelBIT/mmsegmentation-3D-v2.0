...
data_root = '/opt/data/private/project/charelchen.cj/workDir/dataset/Recta/arrange_data_resample_median'
...
train_pipeline = [
    ...
    # dict(type='ResizeMeical', ratio_range=(0., 0.6), keep_ratio=True),
...
test_pipeline = [
        ...
        dict(type='NormalizeMedical', norm_type='full_volume_mean', instensity_min_val=0.5, instensity_max_val=99.5),
        dict(type='PadMedical', size_divisor=(16, 16, 8), pad_val=0, seg_pad_val=0),
        dict(type='BinaryCateogry', ignore_index=255),
        dict(type='ConcatImage'),
