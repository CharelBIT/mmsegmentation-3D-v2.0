...
data_root = '/gruntdata/data/BraTS17/MICCAI_BraTS17_Data_Training/'
crop_size = (64, 64, 64)
train_pipeline = [
...
model = dict(
    ...
    decode_head=dict(
        ...
        align_corners=False,
        loss_decode=dict(
            type='CrossEntropyLoss', use_sigmoid=True, loss_weight=[0.1, 1, 1, 1, 1])),
    # auxiliary_head=dict(
    #     type='FCNHead3D',
    #     in_channels=64,
    #     in_index=-2,
...
log_level = 'INFO'
load_from = '../work_dirs/vnet_base_cfg_fp16/latest.pth'
# work_dirs =
resume_from = None
workflow = [('train', 1)]
